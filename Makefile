...
HDRS = helper_3dmath.h I2Cdev.h MPU6050_6Axis_MotionApps20.h MPU6050.h demo_3d.h Motor.h DMP.h Quadcopter.h
CMN_OBJS = I2Cdev.o MPU6050.o Motor.o
DMP_OBJS = demo_dmp.o
MAIN_OBJS = main.o DMP.o Quadcopter.o
...
$(CMN_OBJS) $(DMP_OBJS) $(RAW_OBJS) $(MAIN_OBJS): $(HDRS)
...
clean:
	rm -f $(CMN_OBJS) $(DMP_OBJS) $(MAIN_OBJS) demo_dmp main
